...
#
sed -e 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9]\)/20\3-\2-\1/g' -e 's/\([0-9]\)\//0\1\//g' -e 's/\([0-9][0-9]\)\/\([0-9][0-9]\)\/\([0-9][0-9][0-9][0-9]\)/\3-\2-\1/g' -e 's/,/./g' -e 's/;/,/g' -e 's/a/A/g' -e 's/c/C/g' -e 's/n/N/g' -e 's/,N/,\\N/g' -e 's/N,$/N,\\\N/g;' -e 's/,,/,\\N,/g' $1 > output.csv